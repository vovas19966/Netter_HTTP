...
namespace Netter_HTTP_Devices
{
    ...
    {
        //инициализация
        public Page_Security_Door()
        {
            InitializeComponent();

            //загрузка comboBox
            ((ScrollViewer_DeviceInfo.MainContent as Grid).Children[5] as ComboBox).ItemsSource = Properties.Settings.Default.Door_Position;
        }
        ...
        {
            Class_Device_Security_Door deviceInfo = new Class_Device_Security_Door(groupID, typeID);
