...
namespace Netter_HTTP_User
{
    ...
    public partial class Page_Security_Window : Page
    {
        ...
        private int TypeIndex = 1; //номер типа
        ...
        public Page_Security_Window(string id, Action<int, string> messageOutput)
        {
            InitializeComponent();


            ((ScrollViewer_Options.MainContent as Grid).Children[5] as ComboBox).ItemsSource = Properties.Settings.Default.Window_Position;
